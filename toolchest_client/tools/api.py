...
def centrifuge(output_path=None, tool_args="", database_name="centrifuge_refseq_bacteria_archaea_viral_human",
               database_version="1", read_one=None, read_two=None, unpaired=None, **kwargs):
    """Runs Centrigue via Toolchest.

    :param output_path: (optional) Path (client-side) to a directory where the output files will be downloaded.
    :param tool_args: (optional) Additional arguments to be passed to Centrifuge.
    :param database_name: (optional) Name of database to use for Centrifuge classification. Uses Refseq with bacteria,
        archaea, viral, and human genomes ("centrifuge_refseq_bacteria_archaea_viral_human") by default.
        Index files generated by the Langmead lab.
    :param database_version: (optional) Version of database to use for Centrifuge classification.
    :type database_version: str
